...
WHERE v1.FDate >='2020-04-01' 
AND v1.FDate <'2020-04-21' 
...
INSERT INTO #T100(FItemID FBegQty FBegPrice FBegBal FBegDiff FSecBegQty)
SELECT  t1.Fnumber AS FItemID SUM(u1.FBegQty) AS FBegQty (Case SUM(u1.FBegQty) WHEN 0 THEN 0 Else (SUM(u1.FBegBal)-SUM(u1.FBegDiff))/SUM(u1.FBegQty) End) AS FBegPrice SUM(u1.FBegBal) AS FBegAmount SUM(u1.FBegDiff) AS FBegDiff SUM(u1.FSecBegQty) AS FBegSecQty --From ICInvBal u1
FROM 
(
	SELECT  ic.FBrNo ic.FYear ic.FPeriod ic.FStockID ic.FItemID ic.FBatchNo ic.FBegQty ic.FReceive ic.FSend ic.FYtdReceive ic.FYtdSend ic.FEndQty ic.FBegBal ic.FDebit ic.FCredit ic.FYtdDebit ic.FYtdCredit ic.FEndBal ic.FBegDiff ic.FReceiveDiff ic.FSendDiff ic.FEndDiff ic.FBillInterID ic.FStockPlaceID ic.FKFPeriod ic.FKFDate ic.FYtdReceiveDiff ic.FYtdSendDiff ic.FSecBegQty ic.FSecReceive ic.FSecSend ic.FSecYtdReceive ic.FSecYtdSend ic.FSecEndQty ic.FAuxPropID ic.FStockInDate ic.FMTONo ic.FSupplyID
	FROM ICInvBal ic
	LEFT JOIN t_Stock t
	...
	AND ic.FYear=2020 
	AND ic.FPeriod=4 
	AND Not (ic.FBegQty = 0 AND ic.FBegBal = 0)  
	UNION ALL
	SELECT  ic.FBrNo ic.FYear ic.FPeriod ic.FStockID ic.FItemID ic.FBatchNo ic.FBegQty ic.FReceive ic.FSend ic.FYtdReceive ic.FYtdSend ic.FEndQty ic.FBegBal ic.FDebit ic.FCredit ic.FYtdDebit ic.FYtdCredit ic.FEndBal ic.FBegDiff ic.FReceiveDiff ic.FSendDiff ic.FEndDiff ic.FBillInterID ic.FStockPlaceID ic.FKFPeriod ic.FKFDate ic.FYtdReceiveDiff ic.FYtdSendDiff ic.FSecBegQty ic.FSecReceive ic.FSecSend ic.FSecYtdReceive ic.FSecYtdSend ic.FSecEndQty ic.FAuxPropID ic.FStockInDate ic.FMTONo ic.FSupplyID
	FROM ICVMIInvBal ic
	WHERE ic.FYear=2020 
...
INSERT INTO #T100(FItemID FBegQty FBegPrice FBegBal FBegDiff FSecBegQty)
SELECT  t1.Fnumber u1.FQty Case t1.FTrack WHEN 81 THEN u1.FPlanPrice Else u1.FPrice End Case t1.FTrack WHEN 81 THEN u1.FPlanAmount Else u1.FAmount End 0 u1.FSecQty
FROM ICStockBill v1
LEFT JOIN ICStockBillEntry u1
ON v1.FInterID=u1.FInterID
INNER JOIN t_ICItem t1
...
ON u1.FDCSPID=t11.FSPID
WHERE v1.FDate >='2020/04/01' 
AND v1.FDate <'2020/04/01' 
AND v1.FPOMode <>36681 
AND (v1.Ftrantype IN (1 2 5 10 40 101 102) Or (v1.Ftrantype=100 AND v1.FBillTypeID=12542)) 
AND isnull(t2.FIncludeAccounting 0) =1 
AND v1.FStatus>0 
AND v1.FCancelLation=0 
...
WHERE v1.FDate >='2020/04/01' 
AND v1.FDate <'2020/04/01' 
AND (v1.Ftrantype IN (21 28 29 43) Or (v1.Ftrantype=100 AND v1.FBillTypeID=12541)) 
AND isnull(t2.FIncludeAccounting 0) =1 
AND v1.FStatus>0 
AND v1.FCancelLation=0 
...
INSERT INTO #T100(FItemID FBegQty FBegPrice FBegBal FBegDiff FSecBegQty)
SELECT  t1.FNumber u1.FQty Case t1.FTrack WHEN 81 THEN u1.FPlanPrice Else u1.FPriceRef End Case t1.FTrack WHEN 81 THEN u1.FPlanAmount Else u1.FAmtRef End 0 u1.FSecQty
FROM ICStockBill v1
LEFT JOIN ICStockBillEntry u1
ON v1.FInterID=u1.FInterID
INNER JOIN t_ICItem t1
...
INSERT INTO #T100(FItemID FBegQty FBegPrice FBegBal FBegDiff FSecBegQty)
SELECT  t1.FNumber -u1.FQty Case t1.FTrack WHEN 81 THEN u1.FPlanPrice Else u1.FPriceRef End Case t1.FTrack WHEN 81 THEN -u1.FPlanAmount Else -u1.FAmount End 0 -u1.FSecQty
FROM ICStockBill v1
LEFT JOIN ICStockBillEntry u1
ON v1.FInterID=u1.FInterID
INNER JOIN t_ICItem t1
...
INSERT INTO #T100(FItemID FBegQty FBegPrice FBegBal FBegDiff FSecBegQty)
SELECT  t1.FNumber u1.FQty u1.FAuxPrice u1.FAmount 0 u1.FSecQty
FROM ICVMIInStock v1
INNER JOIN ICVMIInStockEntry u1
ON v1.FID=u1.FID
LEFT JOIN t_ICItem t1
ON u1.FItemID=t1.FItemID
LEFT JOIN t_Stock t2
